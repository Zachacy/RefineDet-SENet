...
parser.add_argument('--dataset', default='VOC', choices=['VOC', 'COCO','KITTI', 'BDD100K'],
                    type=str, help='VOC or COCO or KITTI, or BDD100k')
parser.add_argument('--input_size', default='320', choices=['320', '512'],
                    type=str, help='RefineDet320 or RefineDet512')
parser.add_argument('--dataset_root', default=BDD100K_ROOT,
...
def train():
    if args.dataset == 'COCO':
        ...
        cfg = kitti_refinedet[args.input_size]
        dataset = KITTIDetection(root=args.dataset_root,
                               transform=SSDAugmentation(cfg['min_dim'],
                                                         MEANS))
    elif args.dataset == 'BDD100K':
        
        cfg = bdd100k_refinedet[args.input_size]
        dataset = BDD100KDetection(root=args.dataset_root,
                               transform=SSDAugmentation(cfg['min_dim'],
                                                         MEANS))
